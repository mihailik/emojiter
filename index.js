...
var emojiter = (function () {
  ...
  Control: [ // \x00 <control-0000>...<reserved-E0FFF>
    ...
    [5328,8],
    798342,1,
    [1,30], // 0x0E_0002 <reserved-E0002>...<reserved-E001F>
    [97,128], // 0x0E_0080 <reserved-E0080>...<reserved-E00FF>
    [241,3600]],
  Extend: [ // \u0300 COMBINING GRAVE ACCENT...VARIATION SELECTOR-256
    ...
    [2,6],
    2,
    [83,22], // 0x01_1C92 MARCHEN SUBJOINED LETTER KA...MARCHEN SUBJOINED LETTER ZA
    [3,7],
    [2,2],
    [2,2],
    [123,6],
    ...
    [31,4],
    [149,3],
    [1980,55], // 0x01_DA00 SIGNWRITING HEAD RIM...SIGNWRITING AIR SUCKING IN
    [5,50], // 0x01_DA3B SIGNWRITING MOUTH CLOSED NEUTRAL...SIGNWRITING EXCITEMENT
    9,15,
    [23,5],
    [2,15],
    [1361,7],
    [2,17], // 0x01_E008 COMBINING GLAGOLITIC LETTER ZEMLJA...COMBINING GLAGOLITIC LETTER HERU
    [3,7],
    [2,2],
    [2,5],
    [262,7],
    ...
    [110,7],
    [2737,5],
    [789537,96], // 0x0E_0020 TAG SPACE...CANCEL TAG
    [129,240]],
  Regional_Indicator: [[127462,26]], // 0x01_F1E6 REGIONAL INDICATOR SYMBOL LETTER A
  SpacingMark: [ // \u0903 DEVANAGARI SIGN VISARGA...MUSICAL SYMBOL COMBINING AUGMENTATION DOT
    ...
    2,
    [351,2],
    [20571,55], // 0x01_6F51 MIAO SIGN ASPIRATION...MIAO VOWEL SIGN UI
    [105,2],
    24949,7],
